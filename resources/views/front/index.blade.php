                        ...
                        <div class="col-md-4 ftco-animate">
                            <div class="product">
                                ...
                                <div class="text py-3 px-3">
                                    ...
                                    <h6><a href="{{url('product/'.$item['id'])}}">{{ $item['product_code'] }}</a></h6>
                                    ...
                                    <p class="bottom-area d-flex px-3">
                                        <a href="{{url('product/'.$item['id'])}}" class="add-to-cart text-center py-2 mr-1"><span>Add to cart <i
                ...
                <div class="col-sm-4 ftco-animate">
                    <div class="product">
                        ...
                        <div class="text py-3 px-3">
                            ...
                            <p class="bottom-area d-flex px-3">
                                <a href="{{url('product/'.$product['id'])}}" class="add-to-cart text-center py-2 mr-1"><span>Add to cart <i
                                            class="ion-ios-add ml-1"></i></span></a>
